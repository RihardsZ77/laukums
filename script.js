function nolasa(m1,m2,m3){
    ...
    function laukums(m1,m2,m3){
        const pusper = perimetrs(m1,m2,m3)/2;
        let trijstlaukums = Math.sqrt(
            pusper* ((pusper - m1)*(pusper-m2)*(pusper-m3)));
            console.log(trijstlaukums);
            return trijstlaukums;
        ...
        function rezultats(){
            ...
            if(!nolasa()) {
                ...
                if (irTrijsturis(m1,m2,m3)==false){
                    t="Trijstūris neeksistē, jo jebkuru 2 malu garumu summmai ir jābūt lielākai par trešo malu!";
                }else{
